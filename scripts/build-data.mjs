...
const MONTHS = [
  // short labels carry the year at each year boundary (Jul ’25, Jan ’26) so the
  // months read unambiguously across the year change.
  { file: "JULY_2025.csv", key: "2025-07", label: "July 2025", short: "Jul ’25" },
